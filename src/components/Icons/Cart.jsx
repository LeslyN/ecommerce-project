function Cart() {
  return (
    <svg className='cart' width='16' height='15' viewBox='0 0 16 15' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#clip0_583_10511)'>
        <path d='M13.3223 11.3487H4.93418L2.46708 0.986816H0.986816M2.9605 2.9605H14.8026L13.3223 9.37497H4.44076L2.9605 2.9605Z' stroke='black' stroke-linecap='round' stroke-linejoin='round' />
        <path
